...
И ещё. Если хочешь не просто выговориться,
а разобраться, почему диалоги с людьми не дают результата

сейчас идут тесты РЕКРУТЕРА в Мультибустеры

он показывает, где ты теряешь человека
и как это исправить

если интересно — пиши Юле @yuliyakuzminova.»
